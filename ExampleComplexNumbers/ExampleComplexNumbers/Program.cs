...
namespace ExampleComplexNumbers
{
    class Complex
    {
        ...
        public static Complex operator -(Complex m, Complex n)
        {
            Complex p = new Complex((m.a * n.b - m.b * n.a) / nod(m.b, n.b), (m.b * n.b) / nod(m.b, n.b));
            p.Simple();
            return p;
        }
        public static Complex operator *(Complex m, Complex n) // 5/9 * 1/3 = 5/27
        {
            Complex p = new Complex(m.a * n.a, m.b * n.b);
            p.Simple();
            return p;
        }
        public static Complex operator /(Complex m, Complex n) // 5/9 * 3/1 = 15/9
        {
